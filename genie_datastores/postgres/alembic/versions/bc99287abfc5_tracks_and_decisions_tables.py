...
def upgrade() -> None:
    ...
    sa.Column('table', sa.Enum('ARTISTS', 'TRACKS', 'TRACKS_LYRICS', name='table'), nullable=False),
    ...
    sa.Column('primary_genre', sa.Enum('ELECTRONIC', 'HIP_HOP', 'INDIE', 'JAZZ', 'MIZRAHI', 'OTHER', 'POP', 'ROCK', 'SINGER_SONGWRITER', 'SOUL', name='primarygenre'), nullable=True),
