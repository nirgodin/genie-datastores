...
# Curators
CURATORS_TABLE = "curators"
CURATORS_TABLE_ID = f"{CURATORS_TABLE}.{ID}"
CURATORS_COLLECTIONS_TABLE = "curator_collections"
CURATORS_COLLECTIONS_TABLE_ID = f"{CURATORS_COLLECTIONS_TABLE}.{ID}"
